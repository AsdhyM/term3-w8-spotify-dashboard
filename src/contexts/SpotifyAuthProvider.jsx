...
const clientId = "fe5450511fb34f0db9ee126f01715b1d";
...
export function SpotifyAuthProvider({children}){
    ...
    useEffect(() => {
        ...
        // localhost:5173/spotifycallback?code=dsjgiaoiiagiogeiawegiaaw,mn
        // code = dsjgiaoiiagiogeiawegiaaw,mn

        setUserAuthCode(code);

        // Empty dependendy array means that this useEffect only runs on page load
        // and never again
    }, []);
    ...
    useEffect(() => {
        ...
        async function getAuthData(){
            ...
            // localhost:5173/spotifycallbackcode?code=fasoijepaghaephgsaehaiop,mn
    ...
    async function getAuthData(clientId, code) {
    ...
    async function redirectToAuthCodeFlow() {
        ...
        // Configure the API request to befin the auth flow with spotify
        const params = new URLSearchParams();
        params.append("client_id", clientId);
